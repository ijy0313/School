...
function zoomFig() {
    ...
    // Show window
    var imageUrl = document.getElementsByTagName('img')[(figureCount == 3 ? 1 : 2)].src;
    var zoomWindow = window.open("zoom.htm?imageUrl=" + imageUrl, "zoomwin", winOptions);
    zoomWindow.focus();
}
...
function createEventListeners() {
    ...
    window.addEventListener('message', function (event) {
        ...
        if (favs.children.length > 5) {
            window.alert('Please remove favourites to add more.');
            return;
        }
